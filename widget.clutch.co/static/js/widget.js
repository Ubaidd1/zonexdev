      ...
      652: function (e, t) {
        ...
        !(function (r) {
          ...
          function T(e) {
            ...
            function n(e) {
              var t = Number(h[E]["max" + e]),
                ...
                i = e.toLowerCase();
              e = Number(T[i]);
              O(E, "Checking " + i + " is in range " + n + "-" + t),
                e < n && ((e = n), O(E, "Set " + i + " to min value")),
                t < e && ((e = t), O(E, "Set " + i + " to max value")),
                (T[i] = "" + e);
            }
            function i(e) {
            ...
            "[iFrameResizerChild]Ready" === I
              ? (function () {
                  for (var e in h)
                    S("iFrame requested init", j(e), h[e].iframe, e);
                })()
              : u === ("" + I).substr(0, l) && I.substr(l).split(":")[0] in h
              ? ((T = (function () {
                ...
                (E = T.id),
                h[E] && (h[E].loaded = !0),
                (x = T.type in { true: 1, false: 1, undefined: 1 }) &&
                  O(E, "Ignoring init message from meta parent page"),
                !x &&
                  ((y = !0),
                  h[(p = E)] ||
                    ((y = !1),
                    M(
                      T.type + " No settings for " + p + ". Message was: " + I
                    )),
                  y) &&
                  (O(E, "Received: " + I),
                  (w = !0),
                  null === T.iframe &&
                    (M(E, "IFrame (" + T.id + ") not found"), (w = !1)),
                  w &&
                    (function () {
                      var t = e.origin,
                      ...
                      if (
                        ...
                        !(function () {
                          return n.constructor === Array
                            ...
                            : ((e = h[E] && h[E].remoteHost),
                              O(E, "Checking connection is from: " + e),
                              t === e);
                          var e;
                        })()
                      )
                    ...
                    (function () {
                      switch (
                        (h[E] && h[E].firstRun && h[E] && (h[E].firstRun = !1),
                        T.type)
                      ) {
                        case "close":
                          F(T.iframe);
                        ...
                        case "pageInfoStop":
                          h[E] &&
                            h[E].stopPageInfo &&
                            (h[E].stopPageInfo(), delete h[E].stopPageInfo);
                          break;
                        case "inPageLink":
                          d(i(9));
                          break;
          ...
          function L(e) {
                  ...
                  function i() {
                    Object.keys(h).forEach(function (e) {
                      ...
                      h[(n = e)] &&
                        ...
                        (t("height") || t("width")) &&
                        S("Visibility change", "resize", h[n].iframe, n);
                    });
                  }
                  function o(e) {
                    O(
            ...
            var n = e.iframe.id;
            h[n] &&
              (h[n].sizeHeight && t("height"), h[n].sizeWidth && t("width"));
          }
          function W(e, t, n) {
          ...
          function P(e, t) {
              ...
              d =
                ("" === (i = e.id) &&
                  ((e.id =
                    ...
                    (i = o))),
                  (s = (t || {}).log),
                  O(i, "Added missing iframe ID: " + i + " (" + e.src + ")")),
                i);
            function c(t) {
              var n = h[d][t];
              1 / 0 !== n &&
            ...
            function u(e) {
              if (h[d]["min" + e] > h[d]["max" + e])
                throw new Error(
                  "Value for min" + e + " can not be greater than max" + e
                );
            }
            d in h && "iFrameResizer" in e
              ? M(d, "Ignored iFrame, already setup.")
              : ((function (t) {
                  (t = t || {}),
                    (h[d] = {
                      firstRun: !0,
                    ...
                    (function (e) {
                      for (var t in p)
                        Object.prototype.hasOwnProperty.call(p, t) &&
                          (h[d][t] = (
                            Object.prototype.hasOwnProperty.call(e, t) ? e : p
                          )[t]);
                    })(t),
                    h[d] &&
                      (h[d].targetOrigin =
                ...
                (function () {
                  switch (
                    (O(
                      d,
                      "IFrame scrolling " +
                        (h[d] && h[d].scrolling ? "enabled" : "disabled") +
                        " for " +
                        d
                    ),
                    (e.style.overflow =
                      !1 === (h[d] && h[d].scrolling) ? "hidden" : "auto"),
                    h[d] && h[d].scrolling)
                  ) {
                    case "omit":
                      break;
                ...
                c("maxWidth"),
                c("minWidth"),
                ("number" != typeof (h[d] && h[d].bodyMargin) &&
                  "0" !== (h[d] && h[d].bodyMargin)) ||
                  ((h[d].bodyMarginV1 = h[d].bodyMargin),
                  (h[d].bodyMargin = h[d].bodyMargin + "px")),
                (function (t) {
                  var n,
                    i = y();
                  i &&
                    ...
                    v(e, "load", function () {
                      var n, i;
                      S("iFrame.onload", t, e, r, !0),
                        (n = h[d] && h[d].firstRun),
                        (i = h[d] && h[d].heightCalculationMethod in g),
                        !n &&
                          i &&
          ...
          "undefined" != typeof window &&
            ...
            (i = []),
            void 0 !== (o = "function" == typeof (n = q) ? n.apply(t, i) : n) &&
              (e.exports = o),
